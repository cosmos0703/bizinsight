...
const NavToggler = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex gap-2">
      ...
      <Link
        to="/category"
        className={`px-4 py-2 rounded-full font-bold shadow-lg transition-all ${isCategory ? 'bg-blue-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-100'}`}
      >
        Category (New)
      </Link>
    </div>
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        {/* V4: Business Category Analysis */}
        <Route path="/category" element={<BusinessCategoryAnalysis />} />
      </Routes>
    </BrowserRouter>
  );
}
