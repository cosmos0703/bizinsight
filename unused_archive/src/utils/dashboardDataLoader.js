...
// File Paths
const FILE_OPENINGS = '/data/openings_district.csv';
const FILE_CLOSURES = '/data/closures_district.csv';
const FILE_REVENUE = '/data/revenue_district.csv';
const FILE_RENT = '/data/rent_district.csv';
